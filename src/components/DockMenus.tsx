...
export default function DockMenus(props: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <Dock direction="middle" {...props}>
      <DockIcon>
        <Link href="https://github.com/prad-alpukat">
          <Icons.gitHub className="size-6" />
        </Link>
      </DockIcon>
      <DockIcon>
        <Link href="https://www.linkedin.com/in/praditya-aldi-syahputra">
          <Icons.linkedin className="size-6" />
        </Link>
      </DockIcon>
      <DockIcon>
        <Link href="https://www.instagram.com/prad.alpukat">
          <Icons.instagram className="size-6" />
        </Link>
      </DockIcon>
      <DockIcon>
        <Link href="mailto:pradityaaldi.s@gmail.com">
